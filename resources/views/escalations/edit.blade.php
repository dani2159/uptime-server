@extends('layouts.app')
@section('title', 'Edit Aturan Eskalasi')
...
<div class="max-w-xl mx-auto px-4 py-6">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-bold dark:text-white">Edit Aturan Eskalasi</h1>
    </div>

    <form method="POST" action="{{ route('escalations.update', $escalation) }}"
