...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-5">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-800">Tambah Insiden Manual</h1>
            <p class="text-xs text-gray-400">Untuk insiden yang tidak terdeteksi otomatis oleh sistem</p>
        </div>
    </div>
