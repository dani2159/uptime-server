@extends('layouts.app')
@section('title', 'Buat Status Page')
...
<div class="max-w-4xl" x-data="statusBuilder({{ $monitorsJson }}, [])">
    ...
    <div class="flex items-center gap-3 mb-5">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-800 dark:text-slate-100">Buat Status Page</h1>
            <p class="text-xs text-gray-400 dark:text-slate-500">Halaman publik untuk menampilkan status layanan</p>
        </div>
    </div>

    <form id="create-form" method="POST" action="{{ route('status-pages.store') }}" class="space-y-5">
        @csrf
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-sky-100 dark:border-slate-700 shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs text-gray-400 dark:text-slate-500 italic">
                    Kelompokkan monitor berdasarkan layanan
                </span>
            </div>

            {{-- Unassigned monitors pill list --}}
        ...
        <div class="flex items-center gap-3">
            <button type="button" @click="prepareAndSubmit('create-form')"
                ...
                <i class="fa-solid fa-floppy-disk mr-1.5"></i>Buat Status Page
            </button>
            <a href="{{ route('status-pages.index') }}"
