@extends('layouts.app')
@section('title', 'Buat Jadwal On-Call')
@section('content')
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-3 mb-5">
        ...
        <h1 class="text-xl font-bold text-gray-800 dark:text-slate-100">Buat Jadwal On-Call</h1>
    </div>
    <form method="POST" action="{{ route('on-call.store') }}">
        @csrf
